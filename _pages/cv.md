...
* High Voltage Intern, SpaceX, 2022-2023
  ...
  * Designed & implemented 500 kW feeder and building distribution to a new production building in 4 weeks.
  * Introduced solar panel expansion to decrease diesel use, turning Starbase into a 50% green energy site.
  * Co-designed the microgrid controller functionality with Tesla Engineers. Functionality allowed our Mega-Packs (smart battery storage) to create seamless transitions from the Utility to isolated island operation.
...
======
* Fellowships
  * Michael Powell Graduate Fellowship
  * Thomas Powell ’62 Fellowship

* Posters
  * 2nd Place Prize -  ECE Fall 2025 Departmental Poster Event